...
import static idea.plugin.protoeditor.lang.parser.PbParserUtil.*;
...
public class PbParser implements PsiParser, LightPsiParser {
  ...
  static boolean AggregateValueEntry(PsiBuilder builder, int level) {
    ...
    exit_section_(builder, level, marker, result, false, AggregateValueRecovery_parser_);
    return result;
  }
  ...
  static Parser BlockBodyOptional_$(Parser aP) {
    return new Parser() {
      public boolean parse(PsiBuilder builder, int level) {
        return BlockBodyOptional(builder, level + 1, aP);
      }
    };
  }
  ...
  static boolean EnumEntry(PsiBuilder builder, int level) {
    ...
    exit_section_(builder, level, marker, result, false, EnumRecovery_parser_);
    return result;
  }
  ...
  static boolean EnumReservedNames(PsiBuilder builder, int level) {
    ...
    result = result && CommaSeparatedList(builder, level + 1, SEMI_parser_, StringValue_parser_);
    exit_section_(builder, marker, null, result);
    return result;
  }
  ...
  static boolean EnumReservedNumbers(PsiBuilder builder, int level) {
    ...
    result = result && CommaSeparatedList(builder, level + 1, SEMI_parser_, EnumReservedRange_parser_);
    exit_section_(builder, marker, null, result);
    return result;
  }
  ...
  public static boolean EnumReservedRange(PsiBuilder builder, int level) {
    ...
    exit_section_(builder, level, marker, result, pinned, EnumReservedRangeRecovery_parser_);
    return result || pinned;
  }
  ...
  static boolean ExtendEntry(PsiBuilder builder, int level) {
    ...
    exit_section_(builder, level, marker, result, false, ExtendRecovery_parser_);
    return result;
  }
  ...
  public static boolean ExtensionRange(PsiBuilder builder, int level) {
    ...
    exit_section_(builder, level, marker, result, pinned, ExtensionRangeRecovery_parser_);
    return result || pinned;
  }
  ...
  public static boolean ExtensionsStatement(PsiBuilder builder, int level) {
    ...
    pinned = result; // pin = 1
    result = result && report_error_(builder, CommaSeparatedList(builder, level + 1, ExtensionsStatement_1_0_parser_, ExtensionRange_parser_));
  ...
  static boolean MessageEntry(PsiBuilder builder, int level) {
    ...
    if (!result) result = SimpleField(builder, level + 1);
    if (!result) result = consumeToken(builder, SEMI);
    exit_section_(builder, level, marker, result, false, MessageRecovery_parser_);
    return result;
  }
  ...
  static boolean MethodOptionsEntry(PsiBuilder builder, int level) {
    ...
    result = OptionStatement(builder, level + 1);
    if (!result) result = consumeToken(builder, SEMI);
    exit_section_(builder, level, marker, result, false, MethodOptionsRecovery_parser_);
    return result;
  }
  ...
  static boolean OneofEntry(PsiBuilder builder, int level) {
    ...
    if (!result) result = GroupDefinition(builder, level + 1);
    if (!result) result = SimpleField(builder, level + 1);
    exit_section_(builder, level, marker, result, false, OneofRecovery_parser_);
    return result;
  }
  ...
  public static boolean OptionList(PsiBuilder builder, int level) {
    ...
    result = consumeToken(builder, LBRACK);
    pinned = result; // pin = 1
    result = result && report_error_(builder, CommaSeparatedList(builder, level + 1, RBRACK_parser_, OptionListEntry_parser_));
  ...
  static boolean OptionListEntry(PsiBuilder builder, int level) {
    ...
    Marker marker = enter_section_(builder, level, _NONE_);
    result = OptionExpression(builder, level + 1);
    exit_section_(builder, level, marker, result, false, OptionListEntryRecovery_parser_);
    return result;
  }
  ...
  static boolean ReservedNumbers(PsiBuilder builder, int level) {
    ...
    result = result && CommaSeparatedList(builder, level + 1, SEMI_parser_, ReservedRange_parser_);
    exit_section_(builder, marker, null, result);
    return result;
  }
  ...
  public static boolean ReservedRange(PsiBuilder builder, int level) {
    ...
    exit_section_(builder, level, marker, result, pinned, ReservedRangeRecovery_parser_);
    return result || pinned;
  }
  ...
  static boolean ServiceEntry(PsiBuilder builder, int level) {
    ...
    if (!result) result = consumeToken(builder, SEMI);
    exit_section_(builder, level, marker, result, false, ServiceRecovery_parser_);
    return result;
  }
  ...
  static boolean TopLevelEntry(PsiBuilder builder, int level) {
    ...
    if (!result) result = OptionStatement(builder, level + 1);
    if (!result) result = consumeToken(builder, SEMI);
    exit_section_(builder, level, marker, result, false, TopLevelRecovery_parser_);
    return result;
  }
  ...
  static final Parser AggregateValueEntry_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return AggregateValueEntry(builder, level + 1);
    }
  };
  static final Parser AggregateValueRecovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return AggregateValueRecovery(builder, level + 1);
    }
  };
  static final Parser EnumEntry_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return EnumEntry(builder, level + 1);
    }
  };
  static final Parser EnumRecovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return EnumRecovery(builder, level + 1);
    }
  };
  static final Parser EnumReservedRangeRecovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return EnumReservedRangeRecovery(builder, level + 1);
    }
  };
  static final Parser EnumReservedRange_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return EnumReservedRange(builder, level + 1);
    }
  };
  static final Parser ExtendEntry_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return ExtendEntry(builder, level + 1);
    }
  };
  static final Parser ExtendRecovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return ExtendRecovery(builder, level + 1);
    }
  };
  static final Parser ExtensionRangeRecovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return ExtensionRangeRecovery(builder, level + 1);
    }
  };
  static final Parser ExtensionRange_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return ExtensionRange(builder, level + 1);
    }
  };
  static final Parser ExtensionsStatement_1_0_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return ExtensionsStatement_1_0(builder, level + 1);
    }
  };
  static final Parser MessageEntry_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return MessageEntry(builder, level + 1);
    }
  };
  static final Parser MessageRecovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return MessageRecovery(builder, level + 1);
    }
  };
  static final Parser MethodOptionsEntry_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return MethodOptionsEntry(builder, level + 1);
    }
  };
  static final Parser MethodOptionsRecovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return MethodOptionsRecovery(builder, level + 1);
    }
  };
  static final Parser OneofEntry_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return OneofEntry(builder, level + 1);
    }
  };
  static final Parser OneofRecovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return OneofRecovery(builder, level + 1);
    }
  };
  static final Parser OptionListEntryRecovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return OptionListEntryRecovery(builder, level + 1);
    }
  };
  static final Parser OptionListEntry_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return OptionListEntry(builder, level + 1);
    }
  };
  static final Parser RBRACK_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return consumeToken(builder, RBRACK);
    }
  };
  static final Parser ReservedRangeRecovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return ReservedRangeRecovery(builder, level + 1);
    }
  };
  static final Parser ReservedRange_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return ReservedRange(builder, level + 1);
    }
  };
  static final Parser SEMI_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return consumeToken(builder, SEMI);
    }
  };
  static final Parser ServiceEntry_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return ServiceEntry(builder, level + 1);
    }
  };
  static final Parser ServiceRecovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return ServiceRecovery(builder, level + 1);
    }
  };
  static final Parser StringValue_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return StringValue(builder, level + 1);
    }
  };
  static final Parser TopLevelRecovery_parser_ = new Parser() {
    public boolean parse(PsiBuilder builder, int level) {
      return TopLevelRecovery(builder, level + 1);
    }
  };

  private static final Parser AggregateValue_0_0_parser_ = BlockBodyOptional_$(AggregateValueEntry_parser_);
  private static final Parser EnumBody_0_0_parser_ = BlockBodyOptional_$(EnumEntry_parser_);
  private static final Parser ExtendBody_0_0_parser_ = BlockBodyOptional_$(ExtendEntry_parser_);
  private static final Parser MessageBody_0_0_parser_ = BlockBodyOptional_$(MessageEntry_parser_);
  private static final Parser MethodOptions_0_0_parser_ = BlockBodyOptional_$(MethodOptionsEntry_parser_);
  private static final Parser OneofBody_0_0_parser_ = BlockBodyOptional_$(OneofEntry_parser_);
  private static final Parser ServiceBody_0_0_parser_ = BlockBodyOptional_$(ServiceEntry_parser_);
}
